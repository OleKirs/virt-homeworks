...
Например, в компании есть развитый отдел продаж и бухгалтерия (особенно при наличии холдинга из нескольких юридических лиц), есть развитый отдел разработки программного продукта и предполагается активная работа с использованием подключения к виртуальным рабочим столам (требования политики ИБ).  
В таком случае возможно такое решение:  
1. Для запуска ПО в интересах бухгалтерии и ЭДО и при наличии достаточно большого количества ВМ c ОС Windows может быть востребована виртуализация на базе Hyper-V.  
